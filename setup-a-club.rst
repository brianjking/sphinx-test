...
This section will guide you through the initial high level details for setting up a club.

Club Name
--------------------------------

The selection of your club name should contain DockDogs and be relevant to your regional area.
    * (ex: Puget Sound DockDogs, Beantown DockDogs, etc.)
